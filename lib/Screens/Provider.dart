...
// //   DatabaseReference ref = _database.reference().child("users/requests");
// //   DataSnapshot snapshot = (await ref.once()) as DataSnapshot;
// //     List<dynamic> data = List<dynamic>.from(snapshot.value);
...
//                       ),
//                       child: ListTile(
//                         title: Text("Food item - ${documentSnapshot['Food items'].toString()}"),
//                         subtitle: Text("""
// Requests - ${documentSnapshot['Requests'].toString()}
...
class _ProviderState extends State<Provider> {
              ...
              child: Column(
                ...
                children: [
                  TextField(
                    ...
                    controller: _foodAgeController,
                    decoration: const InputDecoration(
                        labelText: 'how long has it been cooked'),
                  ),
                  TextField(
                    controller: _fooditemController,
                    decoration: const InputDecoration(
  ...
  Future<void> _update([DocumentSnapshot? documentSnapshot]) async {
    if (documentSnapshot != null) {
      ...
      _shopController.text = documentSnapshot['ShopName'];
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      final String foodQuantity =
                          _foodQuantityController.text.toString();
                      await _items.doc(documentSnapshot!.id).update({
                        "ShopName": shop,
                        "UserName": name,
                        "mobile": mobile,
                    ...
                    child: Container(
                      ...
                      child: ListTile(
                        title: Text(
                            "Food Items - ${documentSnapshot['Food items'].toString()}"),
                        subtitle: Text("""
Request accounts - ${documentSnapshot['Requests'].toString()},
Food Quantity - ${documentSnapshot['foodQuantity'].toString()},
Food Age - ${documentSnapshot['foodAge'].toString()}"""),
                        trailing: SizedBox(
                          width: 100,
                          child: Row(
                            children: [
